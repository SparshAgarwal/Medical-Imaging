...
% hold off
% figure
% plot(notdist_feat1(notdist_labels==0), notdist_feat2(notdist_labels==0), 'b.', 'markersize', 10)
% hold on
% plot(notdist_feat1(notdist_labels==1), notdist_feat2(notdist_labels==1), 'y.', 'markersize', 10)
% hold off
